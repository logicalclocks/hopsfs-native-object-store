 ...
 */
extern void hdfsBuilderSetNameNode(hdfsBuilder* bld, cchar_t* nn);
 ...
 * @param port The port.
 */
extern void hdfsBuilderSetNameNodePort(hdfsBuilder* bld, tPort port);
 ...
 */
extern void hdfsBuilderSetUserName(hdfsBuilder* bld, cchar_t* userName);
 ...
 */
extern void hdfsBuilderSetKerbTicketCachePath(hdfsBuilder* bld, cchar_t* kerbTicketCachePath);
 ...
 * @param bld The HDFS builder
 */
extern void hdfsBuilderSetForceNewInstance(hdfsBuilder* bld);
 ...
 */
extern void hdfsBuilderConfSetStr(hdfsBuilder* bld, cchar_t* key, cchar_t* val);
 ...
 */
extern int hdfsCreateDirectory(hdfsFS fs, cchar_t* path);
 ...
 * @return Returns 0 on success, -1 on error.
 */
extern int hdfsDelete(hdfsFS fs, cchar_t* path, int recursive);
 ...
 */
extern int hdfsDisconnect(hdfsFS fs);

// int hdfsExists(hdfsFS fs, const char *path)
//
extern int hdfsExists(hdfsFS fs, cchar_t* path);
 ...
 */
extern void hdfsFreeFileInfo(hdfsFileInfo* hdfsFileInfoParam, int numEntries);
 ...
 */
extern tOffset hdfsGetCapacity(hdfsFS fs);
 ...
 */
extern tOffset hdfsGetUsed(hdfsFS fs);
 ...
 * NULL on error.
 */
extern hdfsFileInfo* hdfsGetPathInfo(hdfsFS fs, cchar_t* path);
 ...
 */
extern hdfsFileInfo* hdfsListDirectory(hdfsFS fs, cchar_t* path, int* numEntries);
 ...
 */
extern int hdfsChown(hdfsFS fs, cchar_t* path, cchar_t* owner, cchar_t* group);
 ...
 *         error.
 */
extern int hdfsCloseFile(hdfsFS fs, hdfsFile file);
 ...
 * @return Returns 0 on success, -1 on error.
 */
extern int hdfsFlush(hdfsFS fs, hdfsFile file);
 ...
 */
extern tSize hdfsRead(hdfsFS fs, hdfsFile file, void* buffer, tSize length);
 ...
 * @return Returns 0 on success, -1 on error.
 */
extern int hdfsSeek(hdfsFS fs, hdfsFile file, tOffset desiredPos);
 ...
 */
extern tOffset hdfsTell(hdfsFS fs, hdfsFile file);
 ...
 */
extern tSize hdfsWrite(hdfsFS fs, hdfsFile file, void* buffer, tSize length);
 ...
 * @return Returns 0 on success, -1 on error.
 */
extern int hdfsRename(hdfsFS fs, cchar_t* oldPath, cchar_t* newPath);
 ...
 */
extern int hdfsAvailable(hdfsFS fs, hdfsFile file);
...
extern char*** hdfsGetHosts(hdfsFS fs, cchar_t* path, tOffset start, tOffset length);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern void hdfsFreeHosts(char*** src);
 ...
 */
extern tOffset hdfsGetDefaultBlockSize(hdfsFS fs);
 ...
 * @return Returns 0 on success, -1 on error.
 */
extern int hdfsSetWorkingDirectory(hdfsFS fs, cchar_t* path);
 ...
 */
extern char* hdfsGetWorkingDirectory(hdfsFS fs, char* buffer, size_t bufferSize);
 ...
 * @return Returns 0 on success, -1 on error.
 */
extern int hdfsCopy(hdfsFS srcFS, cchar_t* src, hdfsFS dstFS, cchar_t* dst);
 ...
 * @return Returns 0 on success, -1 on error.
 */
extern int hdfsMove(hdfsFS srcFS, cchar_t* src, hdfsFS dstFS, cchar_t* dst);
 ...
 * @return      See hdfsRead
 */
extern tSize hdfsPread(hdfsFS fs, hdfsFile file, tOffset position, void* buffer, tSize length);
 ...
 * @return Returns 0 on success, -1 on error.
 */
extern int hdfsSetReplication(hdfsFS fs, cchar_t* path, int16_t replication);
 ...
 * @return 0 on success else -1
 */
extern int hdfsUtime(hdfsFS fs, cchar_t* path, tTime mtime, tTime atime);
 ...
 */
extern int hdfsFileIsOpenForRead(hdfsFile file);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsFileIsOpenForWrite(hdfsFile file);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsFileGetReadStatistics(hdfsFile file, hdfsReadStatistics** stats);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsReadStatisticsGetRemoteBytesRead(chdfsReadStatistics_t stats);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsFileClearReadStatistics(hdfsFile file);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern void hdfsFileFreeReadStatistics(hdfsReadStatistics* stats);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern hdfsFS hdfsConnectAsUser(cchar_t* nn, tPort port, cchar_t* user);
...
* @deprecated Use hdfsBuilderConnect instead.
 */
extern hdfsFS hdfsConnect(cchar_t* nn, tPort port);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern hdfsFS hdfsConnectAsUserNewInstance(cchar_t* nn, tPort port, cchar_t* user);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern hdfsFS hdfsConnectNewInstance(cchar_t* nn, tPort port);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern void hdfsFreeBuilder(hdfsBuilder* bld);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsConfGetStr(cchar_t* key, char** val);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsConfGetInt(cchar_t* key, int* val);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern void hdfsConfStrFree(char val);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsTruncateFile(hdfsFS fs, cchar_t* path, tOffset newlength);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsUnbufferFile(hdfsFile file);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsHFlush(hdfsFS fs, hdfsFile file);
...
*/
// ENOSYS. NOT IMLEMENTED
extern int hdfsHSync(hdfsFS fs, hdfsFile file);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hdfsFileIsEncrypted(hdfsFileInfo* hdfsFileInfoParam);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern tOffset hdfsGetDefaultBlockSizeAtPath(hdfsFS fs, cchar_t* path);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern int hadoopRzOptionsSetSkipChecksum(hadoopRzOptions* opts, int skip);
...
*/
// ENOSYS. NOT IMLEMENTED
extern int hadoopRzOptionsSetByteBufferPool(hadoopRzOptions* opts, cchar_t* className);
...
*/
// ENOSYS. NOT IMLEMENTED
extern void hadoopRzOptionsFree(hadoopRzOptions* opts);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern hadoopRzBuffer* hadoopReadZero(hdfsFile file, hadoopRzOptions* opts, __int32_t maxLength);
...
*/
// ENOSYS. NOT IMLEMENTED
extern __int32_t hadoopRzBufferLength(chadoopRzBuffer_t buffer);
 ...
 */
// ENOSYS. NOT IMLEMENTED
extern void hadoopRzBufferGet(chadoopRzBuffer_t buffer);
...
*/
// ENOSYS. NOT IMLEMENTED
extern void hadoopRzBufferFree(hdfsFile file, chadoopRzBuffer_t buffer);
